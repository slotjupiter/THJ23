...
namespace THJ
{
    public class PathFinder
    {
        ...
        public List<OverlayTile> FindPath(OverlayTile start, OverlayTile end, List<OverlayTile> inRangeTiles)
        {
            ...
            {
                OverlayTile currentOverlayTile = openList.OrderBy(x => x.sumDistance).First();
                ...
                foreach (var tile in GetNeightbourOverlayTiles(currentOverlayTile))
                {
                    ...
                    tile.distanceFromStart = GetManhattenDistance(start, tile);
                    tile.distanceFromEnd = GetManhattenDistance(end, tile);
